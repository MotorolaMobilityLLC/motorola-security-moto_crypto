...
class ELFFile(object):
    ...
    def _make_section(self, section_header):
        ...
        if sectype == 'SHT_STRTAB':
            ## Motorola -- adding default sh_flags to STRTAB when it is a .strtab section
            ##if (name.startswith(b'.strtab')):
            ##    section_header['sh_flags'] |= SH_FLAGS.SHF_ALLOC
